  ...
  <div class="leadership-cards-stack">
    ...
    <article class="leadership-card">
      <div class="carousel-container">
        <div class="carousel" id="deca-leadership-carousel" style="display: flex; overflow: hidden; border-radius: 8px;">
          ...
          <img src="{{ '/assets/img/DECA/WarriorDash1.jpeg' | relative_url }}" alt="DECA events" style="width: 100%; height: 250px; object-fit: cover; display: none;">
    ...
    <article class="leadership-card">
      <div class="carousel-container">
        <div class="carousel" id="generation-strive-carousel" style="display: flex; overflow: hidden; border-radius: 8px;">
          ...
          <img src="{{ '/assets/img/Generation STRIVE/IMG_4977 (1).jpg' | relative_url }}" alt="Generation STRIVE" style="width: 100%; height: 250px; object-fit: cover; object-position: center 80%; display: none;">
          <img src="{{ '/assets/img/Generation STRIVE/IMG_4985 (1).jpg' | relative_url }}" alt="Generation STRIVE" style="width: 100%; height: 250px; object-fit: cover; display: none;">
        </div>
    ...
    <article class="leadership-card">
      <div class="carousel-container">
        ...
        <div class="carousel-dots" style="text-align: center; margin-top: 10px;">
          <span class="dot active" onclick="currentSlide('nths-president-carousel', 0)" style="height: 10px; width: 10px; background-color: #3eb0d2; border-radius: 50%; display: inline-block; margin: 0 5px; cursor: pointer;"></span>
          <span class="dot" onclick="currentSlide('nths-president-carousel', 1)" style="height: 10px; width: 10px; background-color: #bbb; border-radius: 50%; display: inline-block; margin: 0 5px; cursor: pointer;"></span>
